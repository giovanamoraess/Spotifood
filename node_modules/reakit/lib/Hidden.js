...
var __chunk_3 = require('./chunk-e9f69eed.js');
var Box = require('./Box.js');
var __chunk_4 = require('./chunk-25591e69.js');
var __chunk_5 = require('./chunk-3027c8cd.js');
var __chunk_6 = require('./chunk-0f087053.js');
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement(Box.default, __chunk_1._extends({
      ...
      onTransitionEnd: __chunk_4.callAll(this.handleTransitionEnd, onTransitionEnd)
    }));
  };
...
hoistNonReactStatics(HiddenComponent, Box.default);
var Hidden = styled.default(HiddenComponent).withConfig({
  displayName: "Hidden",
  componentId: "sc-1r7zvzf-0"
})(["transform:", ";", ";&[aria-hidden=\"true\"]{pointer-events:none;", ";", ";}", ";"], __chunk_3.translateWithProps, styledTools.ifProp(__chunk_3.hasTransition, styled.css(["transform-origin:", ";transition:all ", " ", " ", ";"], __chunk_3.originWithProps, styledTools.prop("duration"), styledTools.prop("timing"), styledTools.prop("delay"))), styledTools.ifProp("fade", "opacity: 0"), styledTools.ifProp(__chunk_3.hasTransition, styled.css(["transform:", " ", ";visibility:hidden;will-change:transform,opacity;"], __chunk_3.slideWithProps, __chunk_3.scaleWithProps), "display: none !important"), styledTools.theme("Hidden")); // @ts-ignore
...
var Hidden$1 = as.as("div")(Hidden);

var Hidden$2 = Object.assign(Hidden$1, {
  Container: __chunk_5.HiddenContainer,
  Hide: __chunk_6.HiddenHide,
  Show: __chunk_6.HiddenShow,
  Toggle: __chunk_6.HiddenToggle
});

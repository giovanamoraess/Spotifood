...
var actions = {
  ...
  unregister: function unregister(id) {
    return function (state) {
      ...
      var ordered = as.omit(state.ordered, state.ids[index]);
...
var StepNextComponent = function StepNextComponent(_ref) {
  ...
  return React.createElement(Box.default, __chunk_1._extends({
    onClick: __chunk_4.callAll(props.next, onClick),
    disabled: !props.loop && props.hasNext && !props.hasNext()
  }, props));
};

var StepNext = styled.default(StepNextComponent).withConfig({
...
var StepNext$1 = as.as("button")(StepNext);
...
var StepPreviousComponent = function StepPreviousComponent(_ref) {
  ...
  return React.createElement(Box.default, __chunk_1._extends({
    onClick: __chunk_4.callAll(props.previous, onClick),
    disabled: !props.loop && props.hasPrevious && !props.hasPrevious()
  }, props));
};

var StepPrevious = styled.default(StepPreviousComponent).withConfig({
...
var StepPrevious$1 = as.as("button")(StepPrevious);

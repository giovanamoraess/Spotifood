...
var __chunk_7 = require('./chunk-8931826f.js');
...
function (_React$Component) {
  ...
  function PopoverComponent() {
    ...
    __chunk_1._defineProperty(__chunk_1._assertThisInitialized(__chunk_1._assertThisInitialized(_this)), "getOptions", function () {
      ...
      var arrow = popover.querySelector(__chunk_7.getSelector(__chunk_9.PopoverArrow));
      return {
        placement: placement,
        modifiers: {
          hide: {
...
var Popover = styled.default(PopoverComponent).withConfig({
  displayName: "Popover",
...
var Popover$1 = as.as("div")(Popover);
...
var PopoverContainer = function PopoverContainer(props) {
  return React.createElement(__chunk_5.HiddenContainer, __chunk_1._extends({}, props, {
    onMount: __chunk_4.callAll(onMount, props.onMount)
  }));
};

var PopoverToggleComponent = function PopoverToggleComponent(props) {
  return React.createElement(__chunk_6.HiddenToggle, __chunk_1._extends({
...
var PopoverToggle = styled.default(PopoverToggleComponent).withConfig({
...
var PopoverToggle$1 = as.as("button")(PopoverToggle);

var PopoverShowComponent = function PopoverShowComponent(props) {
  return React.createElement(__chunk_6.HiddenShow, __chunk_1._extends({
    "aria-expanded": props.visible,
    "aria-controls": props.popoverId,
    "aria-haspopup": true
  }, props));
...
var PopoverShow = styled.default(PopoverShowComponent).withConfig({
...
var PopoverShow$1 = as.as("button")(PopoverShow);

var PopoverHideComponent = function PopoverHideComponent(props) {
  return React.createElement(__chunk_6.HiddenHide, __chunk_1._extends({
    "aria-expanded": props.visible,
    "aria-controls": props.popoverId,
    "aria-haspopup": true
  }, props));
...
var PopoverHide = styled.default(PopoverHideComponent).withConfig({
...
var PopoverHide$1 = as.as("button")(PopoverHide);

...
hoistNonReactStatics(ToolbarComponent, Box.default);
var Toolbar = styled.default(ToolbarComponent).withConfig({
  displayName: "Toolbar",
...
var Toolbar$1 = as.as("div")(Toolbar);
...
var ToolbarContent$1 = as.as("div")(ToolbarContent);
...
function (_React$Component) {
  ...
  function ToolbarFocusableComponent(props) {
    ...
    __chunk_1._defineProperty(__chunk_1._assertThisInitialized(__chunk_1._assertThisInitialized(_this)), "getToolbar", function () {
      if (typeof _this.toolbar === "undefined") {
        _this.toolbar = _this.getElement().closest(__chunk_7.getSelector(Toolbar$1));
      }
    ...
    __chunk_1._defineProperty(__chunk_1._assertThisInitialized(__chunk_1._assertThisInitialized(_this)), "getFocusables", function () {
      if (!_this.getToolbar()) return new NodeList();
      return _this.getToolbar().querySelectorAll(__chunk_7.getSelector(ToolbarFocusable));
    });
  ...
  _proto.render = function render() {
    return React.createElement(Box.default, __chunk_1._extends({}, this.props, {
      onFocus: __chunk_4.callAll(this.handleFocus, this.props.onFocus),
...
hoistNonReactStatics(ToolbarFocusableComponent, Box.default);
var ToolbarFocusable = styled.default(ToolbarFocusableComponent).withConfig({
...
var ToolbarFocusable$1 = as.as("div")(ToolbarFocusable);

...
import { a as HiddenContainer } from './chunk-d13f9581.js';
import { c as HiddenToggle, b as HiddenShow, a as HiddenHide } from './chunk-7684adef.js';
import { a as getSelector } from './chunk-0cfb3fe1.js';
...
function (_React$Component) {
  ...
  function PopoverComponent() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getOptions", function () {
      ...
      var arrow = popover.querySelector(getSelector(PopoverArrow));
      return {
        placement: placement,
        modifiers: {
          hide: {
...
var Popover = styled(PopoverComponent).withConfig({
  displayName: "Popover",
  componentId: "s6tfv8-0"
})(["position:absolute;top:0;left:0;user-select:auto;cursor:auto;z-index:999;", ";"], theme("Popover")); // @ts-ignore
...
var PopoverToggle = styled(PopoverToggleComponent).withConfig({
  displayName: "PopoverToggle",
  componentId: "sc-1kg8ilz-0"
})(["", ";"], theme("PopoverToggle")); // @ts-ignore

PopoverToggle.propTypes = {
  popoverId: string,
  visible: bool
};
var PopoverToggle$1 = as("button")(PopoverToggle);
...
var PopoverShow = styled(PopoverShowComponent).withConfig({
  displayName: "PopoverShow",
  componentId: "fiwcg2-0"
})(["", ";"], theme("PopoverShow")); // @ts-ignore

PopoverShow.propTypes = {
  popoverId: string,
  visible: bool
};
var PopoverShow$1 = as("button")(PopoverShow);
...
var PopoverHide = styled(PopoverHideComponent).withConfig({
  displayName: "PopoverHide",
  componentId: "sc-1dmx1zw-0"
})(["", ";"], theme("PopoverHide")); // @ts-ignore

PopoverHide.propTypes = {
  popoverId: string,
  visible: bool
};
var PopoverHide$1 = as("button")(PopoverHide);

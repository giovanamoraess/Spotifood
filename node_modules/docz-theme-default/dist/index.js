...
var withSizes = _interopDefault(require('react-sizes'));
...
var placeholder = _interopDefault(require('polished/lib/mixins/placeholder'));
...
var Clipboard = _interopDefault(require('react-feather/dist/icons/clipboard'));
var copy = _interopDefault(require('copy-text-to-clipboard'));
var reactPowerplug = require('react-powerplug');
...
var BaseTooltip = _interopDefault(require('rc-tooltip'));
...
const H2 = (_a) => {
    ...
    return (core.jsx(Heading, Object.assign({}, props),
        core.jsx(docz.Link, { "aria-hidden": true, to: { hash: `#${props.id}` } },
            core.jsx(Icon, { height: 20 })),
        children));
};
...
const Wrapper = styled('div') `
  ...
  height: 100vh;
`;
const dash = core.keyframes `
  to {
    stroke-dashoffset: 1000;
  }
`;
const spinnerClass = (delay = 0) => core.css `
...
const Link = (_a) => {
    ...
    const Component = isInternal
        ? LinkStyled.withComponent(docz.Link)
        : LinkStyled;
    return isInternal ? (core.jsx(Component, Object.assign({}, props, { to: href }))) : (core.jsx(Component, Object.assign({}, props, { href: href })));
};

const octocatWave = core.keyframes `
  0%, 100% {
    transform: rotate(0);
  }
  20%, 60% {
...
const Svg = styled('svg') `
  ...
  right: 0;
`;
const GithubLink = ({ repository }) => (core.jsx(Link$1, { href: repository, target: "_blank", "aria-label": "View source on Github" },
    core.jsx(Svg, { width: "80", height: "80", viewBox: "0 0 250 250", "aria-hidden": "true" },
        core.jsx("path", { d: "M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z" }),
        core.jsx("path", { className: "octo-arm", fill: "currentColor", d: "M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" }),
        core.jsx("path", { className: "octo-body", fill: "currentColor", d: "M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" }))));
...
`;
const Logo = ({ showBg }) => (core.jsx(docz.ThemeConfig, null, ({ title, themeConfig: { logo } }) => (core.jsx(Wrapper$1, { showBg: showBg },
    core.jsx(docz.Link, { to: "/" }, logo ? (core.jsx(LogoImg, { src: logo.src, width: logo.width, alt: title })) : (core.jsx(LogoText, null, title)))))));
...
`;
const Search = ({ onSearch }) => (core.jsx(Wrapper$2, null,
    core.jsx(Icon$1, null),
    core.jsx(Input, { type: "text", placeholder: "Search here...", onChange: (ev) => {
...
const Submenu = styled.div `
  ...
  margin: 5px 0 0 24px;
`;
const SmallLink = styled(docz.Link) `
  position: relative;
  font-size: 14px;
...
const MenuHeadings = ({ route, onClick }) => (core.jsx(docz.Docs, null, ({ docs }) => {
    const headings = getHeadings(route, docs);
    return (headings.length > 0 && (core.jsx(Submenu, null, headings.map((heading) => (core.jsx(SmallLink, { key: heading.slug, onClick: onClick, to: { pathname: route, hash: heading.slug }, isActive: isSmallLinkActive(heading.slug) }, heading.value))))));
}));

const activeWrapper = core.css `
  padding-left: 0;
...
`;
const linkStyle = ({ colors }) => core.css `
  position: relative;
  display: block;
  padding: 4px 24px;
  font-weight: 600;
...
`;
const getActiveFromClass = (el) => Boolean(el && el.classList.contains('active'));
class MenuLink extends react.Component {
    ...
    render() {
        ...
        return (core.jsx(Wrapper$3, { active: active },
            core.jsx(docz.ThemeConfig, null, config => {
                const route = item.route === '/' ? '/' : item.route;
                const props = Object.assign({}, commonProps(config));
                return item.route ? (core.jsx(docz.Link, Object.assign({}, props, { innerRef: refFn, to: route }))) : (core.jsx(LinkAnchor, Object.assign({}, props, { ref: refFn, href: item.href || '#', target: item.href ? '_blank' : '_self' })));
            }),
            active && item.route && core.jsx(MenuHeadings, { route: item.route })));
    }
}
...
const IconLine = styled.span `
  ...
  left: 0;
  right: 0;
  background: ${p => (p.opened ? sidebarText$1(p) : textColor(p))};
...
`;
const Hamburguer = ({ opened, onClick }) => (core.jsx(ToggleButton, { opened: opened, onClick: onClick },
    core.jsx(Icon$3, { opened: opened },
        core.jsx(IconLine, { opened: opened }),
        core.jsx(IconLine, { opened: opened }),
        core.jsx(IconLine, { opened: opened }))));
...
class SidebarBase extends react.Component {
    ...
    render() {
        const { hidden } = this.state;
        return (core.jsx(docz.Menu, null, initial => {
            const menus = this.state.menus || initial;
            return (core.jsx(react.Fragment, null,
                core.jsx(Wrapper$5, { opened: hidden },
                    core.jsx(Content, null,
                        core.jsx(Hamburguer, { opened: !hidden, onClick: this.handleSidebarToggle }),
                        core.jsx(Logo, { showBg: !hidden }),
                        core.jsx(Search, { onSearch: this.handleSearchDocs(initial, menus) }),
                        menus.length === 0 ? (core.jsx(Empty, null, "No documents found.")) : (core.jsx(Menus, null, menus.map(menu => (core.jsx(Menu, { key: menu.id, item: menu, sidebarToggle: this.handleSidebarToggle, collapseAll: Boolean(this.state.searching) }))))),
                        core.jsx(Footer, null,
                            "Built with",
                            core.jsx(FooterLink, { href: "https://docz.site", target: "_blank" },
                                core.jsx(FooterLogo, { width: 40 }))))),
                core.jsx(ToggleBackground, { opened: hidden, onClick: this.handleSidebarToggle })));
        }));
    }
    removeOverlayClass() {
...
const Sidebar = withSizes(mapSizesToProps)(SidebarBase);

const styles$1 = (props) => core.css `
  ...
  body {
    margin: 0;
    padding: 0;
    ${getter(props, 'config.themeConfig.styles.body')};
  }
...
const Wrapper$6 = styled('div') `
  ...
  max-width: 100vw;
`;
const Main = props => (core.jsx(Wrapper$6, null,
    core.jsx(core.Global, { styles: styles$1(props) }),
    props.children));
...
const Subtitle = styled('p') `
  ...
  font-size: 18px;
`;
const NotFound = () => (core.jsx(docz.ThemeConfig, null, config => (core.jsx(Main, { config: config },
    core.jsx(Sidebar, null),
    core.jsx(Wrapper$7, null,
        core.jsx(Title, null, "Page Not Found"),
        core.jsx(Subtitle, null, "Check if you haven't changed the document route or deleted it!"))))));
...
`;
const Button = (_a) => {
    var { as: Component = BaseButton } = _a, props = __rest(_a, ["as"]);
    return core.jsx(Component, Object.assign({}, props));
};
...
const Page = ({ children, doc: { link, fullpage, edit = true }, }) => {
    const content = (core.jsx(react.Fragment, null,
        link && edit && (core.jsx(EditPage, { href: link, target: "_blank" },
            core.jsx(EditIcon, { width: 14 }),
            " Edit page")),
        children));
    return (core.jsx(docz.ThemeConfig, null, (_a) => {
        var { repository } = _a, config = __rest(_a, ["repository"]);
        return (core.jsx(Main, { config: config },
            repository && core.jsx(GithubLink, { repository: repository }),
            !fullpage && core.jsx(Sidebar, null),
            core.jsx(Wrapper$8, null, fullpage ? content : core.jsx(Container, null, content))));
    }));
};

const theme = () => core.css `
...
const global = (core.jsx(core.Global, { styles: core.css `
      /*
       * Container style
       */
      .ps {
...
const EditorStyled = styled(reactCodemirror2.Controlled) `
  ${theme$1()};
  ${theme()};
  ${p => mq(preStyles(p))};
  position: relative;
...
const CodeMirror = props => (core.jsx(Scrollbar, { option: scrollbarOpts },
    global,
    core.jsx(EditorStyled, Object.assign({}, props))));

const ButtonSwap = (_a) => {
    var { as: Button$$1 = Button, onClick, swap, children } = _a, props = __rest(_a, ["as", "onClick", "swap", "children"]);
    return (core.jsx(reactPowerplug.Toggle, null, ({ toggle, on }) => {
        const Btn = Button$$1;
        ...
        return (core.jsx(Btn, Object.assign({ onClick: handleClick }, props), on ? swap : children));
    }));
};
...
const ActionButton = styled(ButtonSwap) `
  ...
  font-size: 12px;
  text-transform: uppercase;
  color: ${p => rgba(textColor$1(p), 0.4)};
  transition: color 0.3s;

  &:hover {
    color: ${p => rgba(textColor$1(p), 0.7)};
  }
`;
...
const ClipboardAction = (_a) => {
    ...
    return (core.jsx(ActionButton, Object.assign({}, props, { as: ButtonLink, title: "Copy to clipboard", onClick: () => copy(content), swap: core.jsx(Check, { width: 17 }) }),
        core.jsx(Clipboard, { width: 15 })));
};
...
class Editor extends react.Component {
    ...
    render() {
        ...
        const _a = this.props, { mode, children, actions, onChange, className, editorClassName, language: defaultLanguage } = _a, props = __rest(_a, ["mode", "children", "actions", "onChange", "className", "editorClassName", "language"]);
        ...
        return (core.jsx(Wrapper$9, { className: className },
            core.jsx(docz.ThemeConfig, null, config => core.jsx(CodeMirror, Object.assign({}, editorProps(config)))),
            core.jsx(Actions, null, actions || core.jsx(ClipboardAction, { content: code }))));
    }
}
Editor.defaultProps = {
    mode: 'js',
...
const Buttons = styled('div') `
  ...
  padding: 3px 5px;
`;
const ResizeBar = ({ onChangeSize }) => (core.jsx(Wrapper$a, null,
    core.jsx(Buttons, null,
        core.jsx(ActionButton, { onClick: () => onChangeSize('360px', '640px'), title: "Smartphone" },
            core.jsx(Smartphone, { width: 20 })),
        core.jsx(ActionButton, { onClick: () => onChangeSize('768px', '1024px'), title: "Tablet" },
            core.jsx(Tablet, { width: 20 })),
        core.jsx(ActionButton, { onClick: () => onChangeSize('1366px', '1024px'), title: "Monitor" },
            core.jsx(Monitor, { width: 20 })))));

const CodeSandboxLogo = (props) => (core.jsx("svg", Object.assign({}, props, { viewBox: "0 0 512 512" }),
    core.jsx("path", { d: "M69.2898098,165.083974 L69.2898098,276.649443 L152.161311,324.692718 L152.161311,412.603224 L241.327633,463.829131 L241.327633,264.06328 L69.2898098,165.083974 Z M89.0172642,137.098529 L260.121958,235.540974 L427.640018,138.456525 L339.210941,87.2017661 L262.258901,131.853758 L179.736828,84.2839889 L89.0172642,137.098529 Z M272.206216,463.739666 L370.845646,406.905256 L370.845646,322.809124 L444.244039,280.276172 L444.244039,167.397587 L272.206216,266.116045 L272.206216,463.739666 Z M255.633239,512 L34,384.729507 L34,128.977638 L255.644267,0 L477.328236,128.432852 L477.328236,384.321468 L255.633239,512 Z", fill: "currentColor" })));
...
const Actions$1 = styled('div') `
  ...
  padding: 0 5px;
  background: ${p => get('mode')(p) === 'light'
    ? lighten(0.13, borderColor$1(p))
    : darken(0.04, borderColor$1(p))};
  border-left: 1px solid ${get('colors.border')};
  border-bottom: 1px solid ${get('colors.border')};
`;
const actionClass = (p) => core.css `
  padding: 3px 10px;
  border-left: 1px solid ${borderColor$1(p)};
`;
const Action = styled(ActionButton) `
  ${actionClass};
`;
const ActionLink = Action.withComponent('a');
const Clipboard$1 = styled(ClipboardAction) `
  ${actionClass};
`;
const storage = localStorage();
const get$1 = (pos) => storage.get(pos.toString());
const remove = (pos) => storage.remove(pos.toString());
const set = (pos, size) => storage.set(pos.toString(), size);
const parse = (position, key, defaultValue) => {
    const obj = JSON.parse(get$1(position));
...
class RenderBase extends react.Component {
    constructor() {
        ...
        this.unloadListener = () => remove(this.props.position);
        ...
        this.setSize = (fullscreen) => {
            set(this.props.position, JSON.stringify(Object.assign({}, this.state, { fullscreen })));
        };
        this.handleToggle = () => {
    ...
    get actions() {
        ...
        const { codesandbox } = this.props;
        return (core.jsx(Actions$1, { withRadius: this.state.showEditor },
            core.jsx(Action, { onClick: this.handleRefresh, title: "Refresh playground" },
                core.jsx(Refresh, { width: 15 })),
            core.jsx(docz.ThemeConfig, null, config => config.codeSandbox &&
                codesandbox !== 'undefined' && (core.jsx(ActionLink, { href: this.codesandboxUrl(config.native), target: "_blank", title: "Open in CodeSandbox" },
                core.jsx(CodeSandboxLogo, { style: { height: '100%' }, width: 15 })))),
            core.jsx(Clipboard$1, { content: this.state.code }),
            core.jsx(Action, { onClick: this.handleToggle, title: fullscreen ? 'Minimize' : 'Maximize' }, fullscreen ? core.jsx(Minimize, { width: 15 }) : core.jsx(Maximize, { width: 15 })),
            core.jsx(Action, { onClick: this.handleShowEditorToggle, title: showEditor ? 'Close editor' : 'Show editor' },
                core.jsx(Code, { width: 15 }))));
    }
    get resizableProps() {
        ...
        return {
            ...
            handleComponent: {
                right: () => core.jsx(Handle, { full: fullscreen, horizontal: true }),
                bottom: () => core.jsx(Handle, { full: fullscreen, horizontal: false }),
            },
    ...
    render() {
        ...
        const editorProps = {
            css: editorStyle,
            actions: core.jsx(react.Fragment, null),
        };
        return (core.jsx(reactLive.LiveProvider, { code: this.state.code, scope: scope, transformCode: this.transformCode, mountStylesheet: false },
            core.jsx(Overlay, { full: fullscreen },
                fullscreen ? core.jsx(ResizeBar, { onChangeSize: this.handleSetSize }) : null,
                core.jsx(Resizable, Object.assign({}, this.resizableProps),
                    core.jsx(Wrapper$b, { full: fullscreen },
                        core.jsx(PreviewWrapper, { full: fullscreen },
                            core.jsx(StyledPreview, { className: className, style: style }),
                            core.jsx(StyledError, null)),
                        this.actions,
                        core.jsx(EditorWrapper, { showing: showEditor },
                            core.jsx(Pre$1, Object.assign({}, editorProps, { onChange: (code) => this.setState({ code }), readOnly: false }), this.state.code)))))));
    }
}
const Render = props => (core.jsx(docz.ThemeConfig, null, config => (core.jsx(RenderBase, Object.assign({}, props, { showEditor: getter(config, 'themeConfig.showPlaygroundEditor') })))));
...
const TableStyled = styled('table') `
  ...
  ${p => mq(get('styles.table')(p))};
`;
const Table = (props) => (core.jsx(Wrapper$c, null,
    core.jsx(TableStyled, Object.assign({}, props))));

const overlayStyle = (colors) => core.css `
  .rc-tooltip-inner {
...
const Link$2 = styled('a') `
  ...
  color: ${get('colors.primary')};
`;
const Tooltip = ({ text, children }) => (core.jsx(docz.ThemeConfig, null, config => (core.jsx(core.ClassNames, null, ({ css: css$$1 }) => (core.jsx(BaseTooltip, { placement: "top", trigger: ['hover'], overlay: text, overlayClassName: css$$1(overlayStyle(config.themeConfig.colors)) },
    core.jsx(Link$2, { href: "#", onClick: (ev) => ev.preventDefault() }, children)))))));

const light = Object.assign({}, colors, { primary: blue, text: grayDark, link: blue, footerText: grayDark, sidebarBg: grayExtraLight, sidebarText: dark, sidebarHighlight: null, sidebarBorder: grayLight, background: white, border: grayLight, theadColor: gray, theadBg: grayExtraLight, tableColor: dark, tooltipBg: dark, tooltipColor: grayExtraLight, codeBg: lighten(0.02, grayExtraLight), codeColor: gray, preBg: grayExtraLight, blockquoteBg: grayExtraLight, blockquoteBorder: grayLight, blockquoteColor: gray });
...
const Theme = () => (core.jsx(docz.ThemeConfig, null, config$$1 => (core.jsx(emotionTheming.ThemeProvider, { theme: prev => (Object.assign({}, prev, { docz: config$$1.themeConfig })) },
    core.jsx(docz.DocPreview, { components: {
            page: Page,
            notFound: NotFound,
            render: Render,
...
const enhance = docz.theme(config, (_a) => {
    var { mode, codemirrorTheme } = _a, config$$1 = __rest(_a, ["mode", "codemirrorTheme"]);
    return (Object.assign({}, config$$1, { mode, codemirrorTheme: codemirrorTheme || `docz-${mode}`, colors: Object.assign({}, getter(modes, mode), config$$1.colors) }));
});

...
import { Link, ThemeConfig, Docs, Menu, theme, DocPreview } from 'docz';
import { jsx, css, keyframes, Global, ClassNames } from '@emotion/core';
...
const H2 = (_a) => {
    ...
    return (jsx(Heading, Object.assign({}, props),
        jsx(Link, { "aria-hidden": true, to: { hash: `#${props.id}` } },
            jsx(Icon, { height: 20 })),
        children));
};
...
const Link$1 = (_a) => {
    ...
    const Component$$1 = isInternal
        ? LinkStyled.withComponent(Link)
        : LinkStyled;
    return isInternal ? (jsx(Component$$1, Object.assign({}, props, { to: href }))) : (jsx(Component$$1, Object.assign({}, props, { href: href })));
};
...
const Svg = styled('svg') `
  ...
  right: 0;
`;
const GithubLink = ({ repository }) => (jsx(Link$2, { href: repository, target: "_blank", "aria-label": "View source on Github" },
    jsx(Svg, { width: "80", height: "80", viewBox: "0 0 250 250", "aria-hidden": "true" },
        jsx("path", { d: "M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z" }),
        jsx("path", { className: "octo-arm", fill: "currentColor", d: "M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" }),
        jsx("path", { className: "octo-body", fill: "currentColor", d: "M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" }))));
...
`;
const Logo = ({ showBg }) => (jsx(ThemeConfig, null, ({ title, themeConfig: { logo } }) => (jsx(Wrapper$1, { showBg: showBg },
    jsx(Link, { to: "/" }, logo ? (jsx(LogoImg, { src: logo.src, width: logo.width, alt: title })) : (jsx(LogoText, null, title)))))));
...
`;
const Search = ({ onSearch }) => (jsx(Wrapper$2, null,
    jsx(Icon$1, null),
    jsx(Input, { type: "text", placeholder: "Search here...", onChange: (ev) => {
...
const MenuHeadings = ({ route, onClick }) => (jsx(Docs, null, ({ docs }) => {
    const headings = getHeadings(route, docs);
    return (headings.length > 0 && (jsx(Submenu, null, headings.map((heading) => (jsx(SmallLink, { key: heading.slug, onClick: onClick, to: { pathname: route, hash: heading.slug }, isActive: isSmallLinkActive(heading.slug) }, heading.value))))));
}));
...
class MenuLink extends Component {
    ...
    render() {
        ...
        return (jsx(Wrapper$3, { active: active },
            jsx(ThemeConfig, null, config => {
                const route = item.route === '/' ? '/' : item.route;
                const props = Object.assign({}, commonProps(config));
                return item.route ? (jsx(Link, Object.assign({}, props, { innerRef: refFn, to: route }))) : (jsx(LinkAnchor, Object.assign({}, props, { ref: refFn, href: item.href || '#', target: item.href ? '_blank' : '_self' })));
            }),
            active && item.route && jsx(MenuHeadings, { route: item.route })));
    }
}
...
`;
const Hamburguer = ({ opened, onClick }) => (jsx(ToggleButton, { opened: opened, onClick: onClick },
    jsx(Icon$3, { opened: opened },
        jsx(IconLine, { opened: opened }),
        jsx(IconLine, { opened: opened }),
        jsx(IconLine, { opened: opened }))));
...
class SidebarBase extends Component {
    ...
    render() {
        const { hidden } = this.state;
        return (jsx(Menu, null, initial => {
            const menus = this.state.menus || initial;
            return (jsx(Fragment, null,
                jsx(Wrapper$5, { opened: hidden },
                    jsx(Content, null,
                        jsx(Hamburguer, { opened: !hidden, onClick: this.handleSidebarToggle }),
                        jsx(Logo, { showBg: !hidden }),
                        jsx(Search, { onSearch: this.handleSearchDocs(initial, menus) }),
                        menus.length === 0 ? (jsx(Empty, null, "No documents found.")) : (jsx(Menus, null, menus.map(menu => (jsx(Menu$1, { key: menu.id, item: menu, sidebarToggle: this.handleSidebarToggle, collapseAll: Boolean(this.state.searching) }))))),
                        jsx(Footer, null,
                            "Built with",
                            jsx(FooterLink, { href: "https://docz.site", target: "_blank" },
                                jsx(FooterLogo, { width: 40 }))))),
                jsx(ToggleBackground, { opened: hidden, onClick: this.handleSidebarToggle })));
        }));
    }
    removeOverlayClass() {
...
const Wrapper$6 = styled('div') `
  ...
  max-width: 100vw;
`;
const Main = props => (jsx(Wrapper$6, null,
    jsx(Global, { styles: styles$1(props) }),
    props.children));
...
const Subtitle = styled('p') `
  ...
  font-size: 18px;
`;
const NotFound = () => (jsx(ThemeConfig, null, config => (jsx(Main, { config: config },
    jsx(Sidebar, null),
    jsx(Wrapper$7, null,
        jsx(Title, null, "Page Not Found"),
        jsx(Subtitle, null, "Check if you haven't changed the document route or deleted it!"))))));
...
`;
const Button = (_a) => {
    var { as: Component$$1 = BaseButton } = _a, props = __rest(_a, ["as"]);
    return jsx(Component$$1, Object.assign({}, props));
};
...
const Page = ({ children, doc: { link, fullpage, edit = true }, }) => {
    const content = (jsx(Fragment, null,
        link && edit && (jsx(EditPage, { href: link, target: "_blank" },
            jsx(EditIcon, { width: 14 }),
            " Edit page")),
        children));
    return (jsx(ThemeConfig, null, (_a) => {
        var { repository } = _a, config = __rest(_a, ["repository"]);
        return (jsx(Main, { config: config },
            repository && jsx(GithubLink, { repository: repository }),
            !fullpage && jsx(Sidebar, null),
            jsx(Wrapper$8, null, fullpage ? content : jsx(Container, null, content))));
    }));
};
...
const global = (jsx(Global, { styles: css `
      /*
       * Container style
       */
      .ps {
...
const EditorStyled = styled(Controlled) `
  ${theme$2()};
  ${theme$1()};
  ${p => mq(preStyles(p))};
  position: relative;
...
const CodeMirror = props => (jsx(Scrollbar, { option: scrollbarOpts },
    global,
    jsx(EditorStyled, Object.assign({}, props))));

const ButtonSwap = (_a) => {
    var { as: Button$$1 = Button, onClick, swap, children } = _a, props = __rest(_a, ["as", "onClick", "swap", "children"]);
    return (jsx(Toggle, null, ({ toggle, on }) => {
        const Btn = Button$$1;
        ...
        return (jsx(Btn, Object.assign({ onClick: handleClick }, props), on ? swap : children));
    }));
};
...
const ClipboardAction = (_a) => {
    ...
    return (jsx(ActionButton, Object.assign({}, props, { as: ButtonLink, title: "Copy to clipboard", onClick: () => copy(content), swap: jsx(Check, { width: 17 }) }),
        jsx(Clipboard, { width: 15 })));
};
...
class Editor extends Component {
    ...
    render() {
        ...
        return (jsx(Wrapper$9, { className: className },
            jsx(ThemeConfig, null, config => jsx(CodeMirror, Object.assign({}, editorProps(config)))),
            jsx(Actions, null, actions || jsx(ClipboardAction, { content: code }))));
    }
}
Editor.defaultProps = {
    mode: 'js',
...
const Pre = (props) => jsx(Editor, Object.assign({}, props));
...
const Buttons = styled('div') `
  ...
  padding: 3px 5px;
`;
const ResizeBar = ({ onChangeSize }) => (jsx(Wrapper$a, null,
    jsx(Buttons, null,
        jsx(ActionButton, { onClick: () => onChangeSize('360px', '640px'), title: "Smartphone" },
            jsx(Smartphone, { width: 20 })),
        jsx(ActionButton, { onClick: () => onChangeSize('768px', '1024px'), title: "Tablet" },
            jsx(Tablet, { width: 20 })),
        jsx(ActionButton, { onClick: () => onChangeSize('1366px', '1024px'), title: "Monitor" },
            jsx(Monitor, { width: 20 })))));

const CodeSandboxLogo = (props) => (jsx("svg", Object.assign({}, props, { viewBox: "0 0 512 512" }),
    jsx("path", { d: "M69.2898098,165.083974 L69.2898098,276.649443 L152.161311,324.692718 L152.161311,412.603224 L241.327633,463.829131 L241.327633,264.06328 L69.2898098,165.083974 Z M89.0172642,137.098529 L260.121958,235.540974 L427.640018,138.456525 L339.210941,87.2017661 L262.258901,131.853758 L179.736828,84.2839889 L89.0172642,137.098529 Z M272.206216,463.739666 L370.845646,406.905256 L370.845646,322.809124 L444.244039,280.276172 L444.244039,167.397587 L272.206216,266.116045 L272.206216,463.739666 Z M255.633239,512 L34,384.729507 L34,128.977638 L255.644267,0 L477.328236,128.432852 L477.328236,384.321468 L255.633239,512 Z", fill: "currentColor" })));
...
class RenderBase extends Component {
    ...
    get actions() {
        ...
        const { codesandbox } = this.props;
        return (jsx(Actions$1, { withRadius: this.state.showEditor },
            jsx(Action, { onClick: this.handleRefresh, title: "Refresh playground" },
                jsx(Refresh, { width: 15 })),
            jsx(ThemeConfig, null, config => config.codeSandbox &&
                codesandbox !== 'undefined' && (jsx(ActionLink, { href: this.codesandboxUrl(config.native), target: "_blank", title: "Open in CodeSandbox" },
                jsx(CodeSandboxLogo, { style: { height: '100%' }, width: 15 })))),
            jsx(Clipboard$1, { content: this.state.code }),
            jsx(Action, { onClick: this.handleToggle, title: fullscreen ? 'Minimize' : 'Maximize' }, fullscreen ? jsx(Minimize, { width: 15 }) : jsx(Maximize, { width: 15 })),
            jsx(Action, { onClick: this.handleShowEditorToggle, title: showEditor ? 'Close editor' : 'Show editor' },
                jsx(Code, { width: 15 }))));
    }
    get resizableProps() {
        ...
        return {
            ...
            handleComponent: {
                right: () => jsx(Handle, { full: fullscreen, horizontal: true }),
                bottom: () => jsx(Handle, { full: fullscreen, horizontal: false }),
            },
    ...
    render() {
        ...
        const editorProps = {
            css: editorStyle,
            actions: jsx(Fragment, null),
        };
        return (jsx(LiveProvider, { code: this.state.code, scope: scope, transformCode: this.transformCode, mountStylesheet: false },
            jsx(Overlay, { full: fullscreen },
                fullscreen ? jsx(ResizeBar, { onChangeSize: this.handleSetSize }) : null,
                jsx(Resizable, Object.assign({}, this.resizableProps),
                    jsx(Wrapper$b, { full: fullscreen },
                        jsx(PreviewWrapper, { full: fullscreen },
                            jsx(StyledPreview, { className: className, style: style }),
                            jsx(StyledError, null)),
                        this.actions,
                        jsx(EditorWrapper, { showing: showEditor },
                            jsx(Pre$1, Object.assign({}, editorProps, { onChange: (code) => this.setState({ code }), readOnly: false }), this.state.code)))))));
    }
}
const Render = props => (jsx(ThemeConfig, null, config => (jsx(RenderBase, Object.assign({}, props, { showEditor: getter(config, 'themeConfig.showPlaygroundEditor') })))));
...
const TableStyled = styled('table') `
  ...
  ${p => mq(get('styles.table')(p))};
`;
const Table = (props) => (jsx(Wrapper$c, null,
    jsx(TableStyled, Object.assign({}, props))));

const overlayStyle = (colors) => css `
  .rc-tooltip-inner {
...
`;
const Link$3 = styled('a') `
  text-decoration: none;
  color: ${get('colors.primary')};
`;
const Tooltip = ({ text, children }) => (jsx(ThemeConfig, null, config => (jsx(ClassNames, null, ({ css: css$$1 }) => (jsx(BaseTooltip, { placement: "top", trigger: ['hover'], overlay: text, overlayClassName: css$$1(overlayStyle(config.themeConfig.colors)) },
    jsx(Link$3, { href: "#", onClick: (ev) => ev.preventDefault() }, children)))))));
...
const Theme = () => (jsx(ThemeConfig, null, config$$1 => (jsx(ThemeProvider, { theme: prev => (Object.assign({}, prev, { docz: config$$1.themeConfig })) },
    jsx(DocPreview, { components: {
            page: Page,
            notFound: NotFound,
            render: Render,
